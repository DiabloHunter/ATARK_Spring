...
public class CommandCloseInvoice implements ICommand {
    ...
    private static final Logger log = Logger.getLogger(CommandCloseInvoice.class);
    ...
    public ExecutionResult execute(SessionRequestContent content) {
        ...
        try {
            ...
            if (serv.closeInvoice(invCode)) {
                ...
                result.addRequestAttribute("errorMessage", conf.getErrorMessage("closeInvoiceErr"));
